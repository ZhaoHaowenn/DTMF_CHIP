...
create_constraint_mode -name common\
   -sdc_files\
    [list ${::IMEX::dataVar}/mmmc/modes/common/common.sdc]
create_analysis_view -name dtmf_view_hold -constraint_mode common -delay_corner dtmf_corner_min -latency_file ${::IMEX::dataVar}/mmmc/views/dtmf_view_hold/latency.sdc
create_analysis_view -name dtmf_view_setup -constraint_mode common -delay_corner dtmf_corner_max -latency_file ${::IMEX::dataVar}/mmmc/views/dtmf_view_setup/latency.sdc
